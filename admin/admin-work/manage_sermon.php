<?php
    ...
    if(isset($_POST['u'])){
        ...
        $my_update_query = "UPDATE `tbl_sermon_uploads` SET `sermon_title` = '$sermon_title', `sermon_date` = '$sermon_date', `sermon_pastor` = '$sermon_pastor' WHERE `id` = '$get_clicked_id'";
        ...
        $my_select_query = "SELECT * FROM `tbl_sermon_uploads` WHERE `id` = '$get_clicked_id'";
        ...
        $my_delete_query = "DELETE FROM `tbl_sermon_uploads` WHERE `id` = '$get_clicked_id'";
        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Manage Sermons</li>
                    </ol>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="row">
                ...
                <?php
                            ...
                            $get_list_of_sermon_query = "SELECT * FROM `tbl_sermon_uploads` ORDER BY id DESC";
                            $get_list_of_sermon = mysqli_query($my_connection_string,$get_list_of_sermon_query);
                            if($get_list_of_sermon){

                                while($get_sermon_details = mysqli_fetch_array($get_list_of_sermon)){

                                $event_id = $get_sermon_details["id"];
                                $sermon_title = $get_sermon_details["sermon_title"];
                                $sermon_date = $get_sermon_details["sermon_date"];
                                $sermon_pastor = $get_sermon_details["sermon_pastor"];
                                $sermon_filename = $get_sermon_details["file_name"];
                                $sermon_filetype = $get_sermon_details["file_type"];
                    ...
                    <div class='white-box'>
                        <form class='form-horizontal form-material' method='post'>
                            <div class='form-group'>
                                ...
                                <div class='col-md-12'>
                                    <input type='text' placeholder='Enter event title' class='form-control form-control-line' value='".$sermon_title."' name='txt_sermon_title'> </div>
                            </div>

                            <div class='form-group'>
                                <label class='col-md-12'>Sermon Pastor</label>
                                <div class='col-md-12'>
                                    <input type='text' placeholder='Enter event title' class='form-control form-control-line' value='".$sermon_pastor."' name='txt_sermon_pastor'> </div>
                                
                            </div>

                            <div class='form-group'>
                                <label for='example-location' class='col-md-12'>Sermon Date</label>
                                <div class='col-md-12'>
                                    <input type='date' placeholder='Enter event location' class='form-control form-control-line' id='example-location' value='".$sermon_date."' name='txt_sermon_date'> </div>
                            </div>
                            <div class='form-group'>
                                <label class='col-md-12'>Sermon MP3 File</label>
                                <div class='col-md-12'>
                                    <input type='text' value='".$sermon_filename.".".$sermon_filetype."' class='form-control form-control-line' disabled> </div>
                            </div>
                            ...
                            <div class='form-group'>
                                <div class='col-sm-12'>
                                    ...
                                    <button class='btn btn-danger'  name='d'>Delete Sermon</button>
                                </div>
                            </div>
